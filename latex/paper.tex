...
\input{fusion_category}

% Section 3.1.3: Morphism Spaces
\input{morphism_spaces}
...
\input{hardcore_softcore}

% ============================================================
% Part III: Dynamics (To be added)
% ============================================================
% \part{Dynamics for Mobile Anyons}
% \input{hamiltonian_v0}
% \input{hamiltonian_v1}
% \input{hamiltonian_free}
% \input{hamiltonian_creation}

% ============================================================
% Part IV: Properties (To be added)
% ============================================================
% \part{Basic Properties of the Models}
% \input{limiting_cases}
% \input{girardeau}
% \input{partition_functions}
% \input{numerics}
