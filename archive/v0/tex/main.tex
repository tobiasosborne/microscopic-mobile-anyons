...
\input{sections/fusion_ring}

% Section 3.1.2: Fusion Categories
\input{sections/fusion_category}

% Section 3.1.3: Morphism Spaces
\input{sections/morphism_spaces}

% Section 3.5: Diagrammatic Calculus
\input{sections/diagrammatic_calculus}

% Section 3.1.6: Fusion Tree Basis
\input{sections/fusion_tree_basis}

% Section 3.1.8: Examples of Fusion Categories
\input{sections/fusion_category_examples}

% Section 3.1a: Temperley-Lieb Categories
\input{sections/temperley_lieb}

% Section 3.2: Fock Space
\input{sections/fock_space}

% Section 3.3: QM for Lattice Models
\input{sections/qm_lattice}
...
\input{sections/matrix_elements_2local}

% Section 5.1.1: Particle-Conserving Local Hamiltonians
\input{sections/hamiltonian_v0}

% Section 5.1.2: Interactions Without Braiding
\input{sections/hamiltonian_v1}

% Section 5.1.3: Free Anyons with Braiding
\input{sections/hamiltonian_free}
...
\input{sections/module_categories}
\input{sections/boundary_conditions}
