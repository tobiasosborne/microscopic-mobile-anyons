...
<span id="page-4-0"></span>FIG. 4. Hopping and interaction terms for (a) electrons, (b) Ising anyons, and (c) Fibonacci anyons, expressed in the notations used in Fig. 3.
...
<span id="page-7-0"></span>FIG. 9. (Color online) Tunneling process (or "hopping") of (a) an electron, (b) an Ising anyon, and (c) a Fibonacci anyon.
