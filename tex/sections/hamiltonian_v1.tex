...
\end{equation}
defined diagrammatically as $\Htwofusion{e}$ where the input strands carry labels $a, b$ (left to right) and the output strands carry the same labels $a, b$.
...
A non-braiding interaction has the diagrammatic form $\Htwofusion{e}$ where the input strands carry types $X_a, X_b$ and the output strands carry types $X_c, X_d$. The two incoming strands fuse into an intermediate channel $X_e$, which then splits into two outgoing strands. Note that no crossing of strands occurs.
