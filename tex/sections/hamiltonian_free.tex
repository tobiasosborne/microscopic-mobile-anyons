...
\begin{center}
\begin{tabular}{ccc}
$c_{X_a, X_b}$: \braidingover{X_a}{X_b} &
\qquad\qquad &
$c_{X_a, X_b}^{-1}$: \braidingunder{X_a}{X_b}
\end{tabular}
\end{center}

\noindent
Over-crossing: $a$ passes over $b$ (counterclockwise). Under-crossing: $a$ passes under $b$ (clockwise).
...
\begin{equation*}
\underbrace{\fuselefttree{a}{b}{e}{c}{d}}_{\text{Before}}
\quad\xrightarrow{R_{ab}^e}\quad
\underbrace{\fuselefttree{b}{a}{e}{c}{d}}_{\text{After}}
\end{equation*}
