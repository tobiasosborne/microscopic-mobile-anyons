...
\begin{tikzpicture}[scale=0.8]
    % Cup (coevaluation)
    \begin{scope}[xshift=0cm]
        \draw[thick] (-0.5,1.5) arc (180:0:0.5);
        \draw[thick,->-] (-0.5,1.5) -- (-0.5,2.5);
        \draw[thick,-<-] (0.5,1.5) -- (0.5,2.5);
        \node[left] at (-0.5,2) {$X$};
        \node[right] at (0.5,2) {$X$};
        \node at (0,0.8) {$\mathrm{coev}: \one \to X \otimes X^*$};
    \end{scope}
    ...
    \begin{scope}[xshift=6cm]
        ...
        \draw[thick,->-] (0.5,0) -- (0.5,1);
        \draw[thick] (-0.5,1) arc (180:360:0.5);
        \node[left] at (-0.5,0.5) {$X$};
        \node[right] at (0.5,0.5) {$X$};
        \node at (0,2.2) {$\mathrm{ev}: X^* \otimes X \to \one$};
    \end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}[scale=0.7]
    % Left zigzag: bend on left side
    \begin{scope}[xshift=0cm]
        \draw[thick,->-] (0,0) -- (0,1);
        \draw[thick] (0,1) arc (180:0:0.5);
        \draw[thick,-<-] (1,1) -- (1,2);
