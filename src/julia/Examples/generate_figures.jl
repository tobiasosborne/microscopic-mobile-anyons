...
function generate_publication_figures()
    ...
    params_dense = MCParams(Δβ=0.8, t=0.6, J=0.0, μ=0.75)
    c2 = generate_spacetime(6, 40, δ_fib, params_dense; seed=202, N_init=2)
    ...
    params2 = MCParams(Δβ=0.7, t=0.8, J=0.0, μ=0.6)
    ...
    params3 = MCParams(Δβ=1.0, t=1.0, J=0.0, μ=0.55)
    ...
    params4 = MCParams(Δβ=0.8, t=0.7, J=0.0, μ=0.6)
    for i in 1:3
    ...
    params_high = MCParams(Δβ=1.0, t=0.5, J=0.0, μ=0.85)
